...
import dev.rono.igniscore.testsupport.InMemoryExtensionSupport;
import dev.rono.igniscore.testsupport.MockBukkitExtensionTestBase;
import dev.rono.igniscore.testsupport.PdcBackedNbtService;
...
class QuarryCachePersistenceTest extends MockBukkitExtensionTestBase {
    @Test
    void rePlaceRestoresContentsFromLocationFileWhenItemAttachFails() {
        InMemoryExtensionSupport extensionSupport = new InMemoryExtensionSupport();
        IgnisStrategyContext context = ExtensionTestSupport.context(plugin, extensionSupport);
