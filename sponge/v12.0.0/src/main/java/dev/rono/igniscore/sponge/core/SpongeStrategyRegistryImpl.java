...
import dev.rono.igniscore.sponge.strategy.SpongeDefaultExplosionStrategy;
...
@Singleton
public class SpongeStrategyRegistryImpl implements IgnisStrategyRegistry {
    ...
    private final SpongeDefaultExplosionStrategy fallbackStrategy = new SpongeDefaultExplosionStrategy();

    @Inject
    public SpongeStrategyRegistryImpl() {
