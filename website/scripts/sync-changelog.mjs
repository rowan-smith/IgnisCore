...
const FALLBACK_RELEASES = [
  {
    ...
    name: `IgnisCore ${siteVars.version}`,
...
async function fetchReleases() {
  ...
  const response = await fetch(url, {
    headers: {Accept: 'application/vnd.github+json', 'User-Agent': 'IgnisCore-Docs'},
  });
...
function renderChangelogMarkdown(releases) {
  const lines = [
    '---',
    'title: Changelog',
    'description: Release history and notes for IgnisCore.',
    'slug: /changelog',
    '---',
    '',
