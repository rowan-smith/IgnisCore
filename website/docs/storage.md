...
Bundled extensions are not shipped with the plugin JAR. Copy built extension JARs from [IgnisCore-Extensions](https://github.com/%%site.extensionsRepo%%) into these folders, then reload.
