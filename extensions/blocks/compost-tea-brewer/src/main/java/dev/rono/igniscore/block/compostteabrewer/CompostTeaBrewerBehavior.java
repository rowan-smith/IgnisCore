...
final class CompostTeaBrewerBehavior {
    ...
    CompostTeaBrewerBehavior(IgnisStrategyContext context) {
    ...
    private void tick(BlockDefinition definition, IgnisLocation location) {
        ...
        ProcessingGuiSupport.setOutput(context.getExtensionSupport(), inventory, OUTPUT_SLOT, "splash_potion", 1);
        IgnisWorld world = worldAt(location);
