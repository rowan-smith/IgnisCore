...
final class IrrigationSprinklerListeners implements OnBlockPlaceListener, OnBlockBreakListener, OnBlockInteractListener {
    private static final int WATER_SLOT = 13;

    private final IgnisStrategyContext context;
    private final BlockStorageRegistry registry;

    IrrigationSprinklerListeners(IgnisStrategyContext context) {
