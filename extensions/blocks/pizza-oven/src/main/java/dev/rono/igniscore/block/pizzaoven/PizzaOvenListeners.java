...
final class PizzaOvenListeners implements OnBlockPlaceListener, OnBlockBreakListener, OnBlockInteractListener {
    ...
    PizzaOvenListeners(IgnisStrategyContext context) {
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
                ...
                PlacedTickSupport.start(context, event.block().location(), StrategySupport.customInt(event.block().definition(), "tickPeriod", 50),
