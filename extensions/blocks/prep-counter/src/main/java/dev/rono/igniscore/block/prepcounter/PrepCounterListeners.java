...
final class PrepCounterListeners implements OnBlockPlaceListener, OnBlockBreakListener, OnBlockInteractListener {
    ...
    PrepCounterListeners(IgnisStrategyContext context) {
