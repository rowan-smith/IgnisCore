...
final class FortuneCookieMakerListeners implements OnBlockPlaceListener, OnBlockBreakListener, OnBlockInteractListener {
    ...
    FortuneCookieMakerListeners(IgnisStrategyContext context) {
