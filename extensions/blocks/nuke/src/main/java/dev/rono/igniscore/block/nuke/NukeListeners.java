...
final class NukeListeners implements OnBlockPlaceListener, OnBlockActivateListener, OnBlockTickListener, OnBlockTriggerListener {
    private final IgnisStrategyContext context;

    NukeListeners(IgnisStrategyContext context) {
