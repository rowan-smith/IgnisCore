...
final class IceCreamFreezerBehavior {
    ...
    IceCreamFreezerBehavior(IgnisStrategyContext context) {
    ...
    private void tick(BlockDefinition definition, IgnisLocation location) {
        ...
        ProcessingGuiSupport.setOutput(context.getExtensionSupport(), inventory, OUTPUT_SLOT, "bowl", 1);
