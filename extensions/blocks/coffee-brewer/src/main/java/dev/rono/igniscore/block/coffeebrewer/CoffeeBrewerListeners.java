...
final class CoffeeBrewerListeners implements OnBlockPlaceListener, OnBlockBreakListener, OnBlockInteractListener {
    ...
    CoffeeBrewerListeners(IgnisStrategyContext context) {
