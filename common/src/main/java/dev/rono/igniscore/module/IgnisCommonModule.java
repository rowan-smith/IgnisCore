...
public class IgnisCommonModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(IgnisIntegrationRegistry.class).toProvider(IgnisIntegrationRegistryProvider.class).in(Scopes.SINGLETON);
        bind(IgnisWorldRegionService.class).in(Scopes.SINGLETON);
