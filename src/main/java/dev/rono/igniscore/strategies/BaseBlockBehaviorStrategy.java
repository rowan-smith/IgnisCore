...
public abstract class BaseBlockBehaviorStrategy implements BlockBehaviorStrategy {
    ...
    protected void spawnNukeFuseParticles(RuntimeBlockInstance instance) {
        int ticksLeft = instance.getTicksLeft();
    ...
    protected void spawnNukeDetonationParticles(Location center, float power) {
        World world = center.getWorld();
    ...
    protected void spawnSpiderStormBurst(Location center, float power) {
        World world = center.getWorld();
