...
enum ExtensionKind {
    ...
    BlockDefinition parseBlock(YamlConfiguration config, String defaultId, int modelData, String extensionId) {
        if (this != BLOCK) {
    ...
    ItemDefinition parseItem(YamlConfiguration config, String defaultId, int modelData, String extensionId) {
        if (this != ITEM) {
