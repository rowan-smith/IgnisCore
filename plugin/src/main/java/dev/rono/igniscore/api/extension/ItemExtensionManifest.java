...
public final class ItemExtensionManifest extends ExtensionManifest {
    private ItemExtensionManifest(String id, String name, String version, String apiVersion, String mainClass, String author) {
    ...
    public static ItemExtensionManifest fromStream(InputStream inputStream) {
        ...
        String mainClass = Objects.requireNonNull(config.getString("main"), "item-extension.yml requires main");
