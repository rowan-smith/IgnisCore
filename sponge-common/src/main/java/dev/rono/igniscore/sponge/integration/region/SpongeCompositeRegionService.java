 ...
 */
public final class SpongeCompositeRegionService implements IgnisRegionService {
    private final SpongeWorldEditRegionService worldEdit;
    private final IgnisWorldRegionService fallback;

    @Inject
    public SpongeCompositeRegionService(SpongeWorldEditRegionService worldEdit, IgnisWorldRegionService fallback) {
